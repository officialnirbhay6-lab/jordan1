...
registerMessageCallback(async (msg) => {
  ...
  // STRICT SUMMONS MODE: Jordan must only activate on chats when explicitly summoned by name!
  if (!text.includes('jordan')) {
    return; // Ignore ordinary messages that don't name-drop 'jordan'
  }
