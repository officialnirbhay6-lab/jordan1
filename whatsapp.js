  ...
  try {
    const puppeteerArgs = {
      ...
      args: [
        ...
        '--disable-blink-features=AutomationControlled', // STEALTH FLAG: Hides Puppeteer webdriver automation indicator from WhatsApp
        '--js-flags="--max-old-space-size=150"' // Restricts Chrome memory footprint
      ],
